...
class MarkColorDB(db.Model):
    ...
    uuid: str(36); non-null; foreign-key("authDB.uuid");
    index: int; non-unique; non-null;
    color: enum; non-unique; non-null; # TODO
    time: date_time; non-unique; non-null; # TODO
    """
    ...
    def __init__(self, id, uuid, index, color, time):
        self.id = id
        self.uuid = uuid
        self.index = index
        self.color = color
    ...
    @staticmethod
    def get_by_uuid_index(uuid, index):
