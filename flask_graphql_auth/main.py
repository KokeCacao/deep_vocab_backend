...
class GraphQLAuth(object):
    ...
    def init_app(self, app):
        ...
        secret_key = app.config.get("JWT_SECRET_KEY") or app.config.get(
            "SECRET_KEY")
        if not secret_key:
            raise Exception(
    ...
    def _set_default__configuration_options(app):
        ...
        app.config.setdefault(
            ...
            "token")  # Name of token argument in GraphQL request resolver
        app.config.setdefault("JWT_REFRESH_TOKEN_ARGUMENT_NAME",
                              "refresh_token")
        ...
        # Added by Koke_Cacao
        app.config.setdefault("JWT_ERROR", "jwt_error")
